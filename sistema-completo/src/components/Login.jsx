  ...
  return (
    <main style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', background: '#f1f5f9', padding: 20 }}>
      <form onSubmit={handleSubmit} style={{ width: '100%', maxWidth: 420, background: '#fff', padding: 36, borderRadius: 16, boxShadow: '0 10px 30px rgba(15,23,42,.1)' }}>
        ...
        <p style={{ color: '#64748b', marginBottom: 28 }}>Entre com o e-mail e senha do administrador</p>
        ...
        <label style={{ display: 'block', marginBottom: 16 }}>
          Senha
          <input type='password' value={senha} onChange={event => setSenha(event.target.value)} required autoComplete='current-password' style={{ display: 'block', width: '100%', padding: 12, marginTop: 6, border: '1px solid #cbd5e1', borderRadius: 8 }} />
        </label>
